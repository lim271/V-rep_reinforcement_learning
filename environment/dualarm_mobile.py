...
class Dualarm_mobile(Core):
    ...
    def controller(self,action):
        ...
        vrep.simxSetJointTargetVelocity(wheelJoints[1],-forwBackVel-leftRightVel-rotVel)
        vrep.simxSetJointTargetVelocity(wheelJoints[2],-forwBackVel+leftRightVel-rotVel)
        vrep.simxSetJointTargetVelocity(wheelJoints[3],-forwBackVel-leftRightVel+rotVel)
        vrep.simxSetJointTargetVelocity(wheelJoints[4],-forwBackVel+leftRightVel+rotVel)
